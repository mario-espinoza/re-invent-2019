...
namespace ComprehendLab
{
    class Program
    {
        ...
        private static string DetectEntities(string text, AmazonComprehendClient comprehendClient)
        {
            ...
            {
                stringBuilder.AppendLine(string.Format("Text: {1}, Type: {1}, Score: {2}, BeginOffset: {3}, EndOffset: {4}",
        ...
        private static string DetectKeyPhrases(string text, AmazonComprehendClient comprehendClient)
        {
            ...
            {
                stringBuilder.AppendLine(string.Format("Text: {1}, Type: {1}, BeginOffset: {2}, EndOffset: {3}",
                    keyPhrase.Text, keyPhrase.Text, keyPhrase.BeginOffset, keyPhrase.EndOffset));
            }
